package com.example.mongoflux.demo.code.config;
...
@Configuration public class ProductRedisConfiguration {

    @Bean ReactiveRedisOperations<String, Product> redisOperations(
